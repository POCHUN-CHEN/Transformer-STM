...
tuner = kt.RandomSearch(
    build_model,
    objective='val_mae',
    max_trials=10,  # 可以設置更多或更少的試驗次數
    executions_per_trial=1,
    directory='my_dir',
    project_name='complex_conv_transformer'
)
...
model.fit(train_data_generator, epochs=50, validation_data=val_data_generator)

# 保存模型權重
model.save_weights('random_serch_convolutional_transformer_model_weights.h5')